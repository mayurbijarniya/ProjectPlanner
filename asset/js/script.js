...
class Project {
  ...
  renderProject() {
    const pListContainer = document.querySelector(
...
class Manager {
  constructor() {
    ...
    ////////drag
    const aProjectsContainer = document.querySelector(
      ".card--activeProjects .projects"
    );
    const pProjectsContainer = document.querySelector(
      ".card--pendingProjects .projects"
    );
    const fProjectsContainer = document.querySelector(
      ".card--finishedProjects .projects"
    );
    ...
    aProjectsContainer.addEventListener("drop", (evnt) => {
      const draggedProj = document.querySelector(
        `[data-id="${evnt.dataTransfer.getData("text/plain")}"]`
      );
      const activebtn = draggedProj.querySelector(".btn--activate");
      aProjectsContainer.classList.remove("draggable");
      if (activebtn)
        //means active project is dragged here...else pending project is dragged
        activebtn.click();
    });
